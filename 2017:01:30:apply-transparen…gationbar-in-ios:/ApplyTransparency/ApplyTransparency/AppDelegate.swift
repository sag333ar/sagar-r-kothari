...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
	...
	func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
		...
		self.applyTransparencyToNavigationControllersBar(splitViewController.viewControllers[0] as! UINavigationController)
		self.applyTransparencyToNavigationControllersBar(splitViewController.viewControllers[1] as! UINavigationController)
		return true
	}
